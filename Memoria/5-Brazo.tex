...
\begin{itemize}
	...
	Esta función se usa para enviar mensajes al brazo. Primero construye el mensaje según la estructura de arrays vista anteriormente en este mismo capítulo, y una vez construido lo publica en el topic al que se ha subscrito:
	\begin{lstlisting}
	def send_msg(self):
		msg = JointTrajectory()
	...
	La siguiente función es la responsable de que al mover un deslizador en la ventana se pueda enviar ese valor al brazo. Aunque sólo se muestra la de una articulación, las demás siguen el mismo esquema. Simplemente escribe el nuevo valor en el array de posiciones, que se enviará al construir el mensaje que moverá al brazo:
	\begin{lstlisting}
