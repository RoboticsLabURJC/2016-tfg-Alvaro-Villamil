...
\begin{figure}[p]
	\centering
	\subfigure[elbow\_joint]{\includegraphics[width=0.465\textwidth]{brazopos1.png}}\hspace{0.07\textwidth}	
	\subfigure[linear\_arm\_actuator\_joint]{\includegraphics[width=0.45\textwidth]{brazopos2.png}}
	\subfigure[shoulder\_lift\_joint]{\includegraphics[width=0.45\textwidth]{brazopos3.png}}\hspace{0.07\textwidth}
	\subfigure[shoulder\_pan\_joint]{\includegraphics[width=0.457\textwidth]{brazopos4.png}}
