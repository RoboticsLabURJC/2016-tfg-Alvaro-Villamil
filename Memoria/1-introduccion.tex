...
\begin{enumerate}[1.]
	...
	\begin{figure}[h]
		\centering
		\subfigure[Robot perro]{\includegraphics[width=0.35\textwidth]{robotperro.jpg}}\hspace{0.04\textwidth}	
		\subfigure[Robot araña]{\includegraphics[width=0.35\textwidth]{robotarana.png}}\vspace{0.03\textwidth}
		\subfigure[Robot pez]{\includegraphics[width=0.35\textwidth]{robotpez.jpg}}\hspace{0.04\textwidth}
		\subfigure[Robot serpiente]{\includegraphics[width=0.35\textwidth]{robotserpiente.png}}
	...
	\begin{figure}[h]
		\centering\includegraphics[width=0.3\textwidth]{robothibrido.jpg}
