...
\begin{figure}[h]
	\centering\includegraphics[width=0.8\textwidth]{gatoraton.png}
...
\begin{figure}[h]
	\centering\includegraphics[width=0.5\textwidth]{turtlebot_simulado.png}
...
\begin{figure}[h]
	\centering\includegraphics[width=0.5\textwidth]{f1.png}
...
\begin{figure}[h]
	\centering\includegraphics[width=0.7\textwidth]{teletaxi-city2.png}
