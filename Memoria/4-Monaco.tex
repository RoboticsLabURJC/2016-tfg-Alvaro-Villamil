...
meter esquema de gaxebo-ICE-app del estudiante
*********************************
...
\begin{figure}[]
	\centering
	\subfigure[Mónaco plano]{\includegraphics[width=0.45\textwidth]{monacolinea.png}}\hspace{0.03\textwidth}
	\subfigure[Mónaco con elevaciones]{\includegraphics[width=0.45\textwidth]{monacoelevlinea.png}}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.35\textwidth]{exportar.png}
